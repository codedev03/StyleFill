"""
Django settings for aiswarya project.
...
CSRF_TRUSTED_ORIGINS = ['web-production-e92a.up.railway.app', 'https://web-production-e92a.up.railway.app']
...
WSGI_APPLICATION = 'aiswarya.wsgi.application'
